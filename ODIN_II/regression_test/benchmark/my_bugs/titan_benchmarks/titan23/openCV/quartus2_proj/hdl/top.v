...
//inout		          		MAX_I2C_SDAT;
input						MAX_I2C_SDAT;
wire 						MAX_I2C_SDAT;											//ODIN DOES NOT HANDLE INOUTS
...
//inout		          		TEMP_SMDAT;
input						TEMP_SMDAT;
wire 						TEMP_SMDAT;												//ODIN DOES NOT HANDLE INOUTS
...
//inout		          		EEP_SDA;
input						EEP_SDA;
wire 						EEP_SDA;												//ODIN DOES NOT HANDLE INOUTS									
...
//inout		     [3:0]		ETH_MDIO;
input			 [3:0]		ETH_MDIO;
wire 			 [3:0]		ETH_MDIO;												//ODIN DOES NOT HANDLE INOUTS
...
//inout		    [15:0]		FSM_D;
input			[15:0]		FSM_D;
wire 			[15:0]		FSM_D;													//ODIN DOES NOT HANDLE INOUTS
...
//inout		    [31:0]		OTG_D;
input			[31:0]		OTG_D;
wire 			[31:0]		OTG_D;													//ODIN DOES NOT HANDLE INOUTS
...
ext_pll_ctrl ext_pll_ctrl_Inst(													//DOES NOT EXIST IN DIRECTORY
...
pll myPll																		//DOES NOT EXIST IN DIRECTORY
	(	
		.areset(~rstn),
		.inclk0(OSC_50_BANK2),
		.c0(clk),
...
usb_portmux usb_portmux_inst(															//DOES NOT EXIST IN DIRECTORY
	.reset_n(rstn),
	.clk(clk),
...
system mySystem(																		//DOES NOT EXIST IN DIRECTORY
    .clk(clk),
