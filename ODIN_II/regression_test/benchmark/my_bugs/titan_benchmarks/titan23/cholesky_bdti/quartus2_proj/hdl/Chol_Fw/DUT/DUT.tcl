...
} elseif {![file exists "./rtl/Chol_Fw/DUT/DUT.tcl"]}    {
...
set_global_assignment -name TOP_LEVEL_ENTITY Chol_Fw_DUT
set_global_assignment -name DEVICE AUTO
set_global_assignment -name DEVICE_FILTER_SPEED_GRADE 2
set_global_assignment -name USE_TIMEQUEST_TIMING_ANALYZER ON
set_global_assignment -name SDC_FILE ./rtl/Chol_Fw/DUT/DUT.sdc

source ./rtl/Chol_Fw/DUT/DUT.add.tcl
...
set_instance_assignment -name VIRTUAL_PIN ON -to MatSizeIn_s
set_instance_assignment -name VIRTUAL_PIN ON -to ProcUpper_s
set_instance_assignment -name VIRTUAL_PIN ON -to go_s
set_instance_assignment -name VIRTUAL_PIN ON -to q_re
set_instance_assignment -name VIRTUAL_PIN ON -to q_im
set_instance_assignment -name VIRTUAL_PIN ON -to q_v_s
set_instance_assignment -name VIRTUAL_PIN ON -to y_v_o_s

source "./rtl/Chol_Fw/DUT/Chol_Fw_DUT_fpc.add.tcl"
