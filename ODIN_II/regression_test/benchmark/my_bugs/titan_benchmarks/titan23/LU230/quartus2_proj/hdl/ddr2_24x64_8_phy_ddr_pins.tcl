...
set patterns [list]
lappend patterns addrcmd ${instname}_alt_mem_phy_siii_*inst|*adc|*addr\[*\].addr_struct|*addr_pin|dataout
lappend patterns addrcmd ${instname}_alt_mem_phy_siii_*inst|*adc|*ba\[*\].ba_struct|*addr_pin|dataout
lappend patterns addrcmd ${instname}_alt_mem_phy_siii_*inst|*adc|*cas_n_struct|*addr_pin|dataout
lappend patterns addrcmd ${instname}_alt_mem_phy_siii_*inst|*adc|*ras_n_struct|*addr_pin|dataout
lappend patterns addrcmd ${instname}_alt_mem_phy_siii_*inst|*adc|*we_n_struct|*addr_pin|dataout
...
set outputFileName "ddr2_24x64_8_phy_autodetectedpins.tcl"
...
set ddr2_24x64_8_phy_use_high_performance_timing 1
if {[namespace which -variable ::override_ddr2_24x64_8_phy_use_high_performance_timing] != ""} {
  set ddr2_24x64_8_phy_use_high_performance_timing $::override_ddr2_24x64_8_phy_use_high_performance_timing
}
