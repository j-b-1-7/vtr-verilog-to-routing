#Quartus II compatible SDC file for benchmark 'LU230'
...
create_clock -period 1.0 -name phy_clk [get_ports {phy_clk}]
...
# set_clock_groups 
#*******************************
set_clock_groups -exclusive -group { clk } -group { phy_clk } 
