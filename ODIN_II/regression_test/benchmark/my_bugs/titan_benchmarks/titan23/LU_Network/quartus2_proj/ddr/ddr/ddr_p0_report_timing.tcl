...
foreach inst $instances {
	...
	foreach opc $opcs {
		...
		perform_resync_timing_analysis $opcs $opcname $inst ${::GLOBAL_ddr_p0_corename} $family $DQS_min_max $io_std $interface_type $period pins t summary MP IP board fpga SSN
