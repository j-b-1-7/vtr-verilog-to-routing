...
#############################################################
proc DE4_SOPC_ddr2_0_p0_perform_flexible_write_launch_timing_analysis {opcs opcname inst family DQS_min_max interface_type max_package_skew dll_length period pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name} {
	...
	set msg_list [ list ]
	set dqs_pll_clock_id [DE4_SOPC_ddr2_0_p0_get_output_clock_id $pins(dqs_pins) "DQS output" msg_list]
	...
	if {($result == 1)} {
		...
		foreach dqpins $pins(q_groups) {
			...
			set DQSperiphery_delay [DE4_SOPC_ddr2_0_p0_min_in_collection $DQSperiphery_min "arrival_time"]
			set aiot_delay [DE4_SOPC_ddr2_0_p0_round_3dp [expr [DE4_SOPC_ddr2_0_p0_get_min_aiot_delay $dqspin] * 1e9]]
			...
			foreach dqpin $dqdmpins {
				...
				# Perform the default timing analysis to get required and arrival times
				set pin_setup_slack [DE4_SOPC_ddr2_0_p0_min_in_collection_to_name $paths_setup "slack" $dqpin]
				set pin_hold_slack  [DE4_SOPC_ddr2_0_p0_min_in_collection_to_name $paths_hold "slack" $dqpin]
				...
				set DQperiphery_delay [DE4_SOPC_ddr2_0_p0_min_in_collection $DQperiphery_min "arrival_time"]
				set aiot_delay [DE4_SOPC_ddr2_0_p0_round_3dp [expr [DE4_SOPC_ddr2_0_p0_get_min_aiot_delay $dqpin] * 1e9]]
	...
	if {$IP(write_deskew_mode) == "dynamic"} {
		lappend wr_summary [list "  Before Calibration Write" [DE4_SOPC_ddr2_0_p0_format_3dp $default_setup_slack] [DE4_SOPC_ddr2_0_p0_format_3dp $default_hold_slack]]
	} else {
		lappend wr_summary [list "  Standard Write" [DE4_SOPC_ddr2_0_p0_format_3dp $default_setup_slack] [DE4_SOPC_ddr2_0_p0_format_3dp $default_hold_slack]]
	}
	
	if {($IP(write_deskew_mode) == "dynamic") && ($IP(mp_calibration) == 1) && ($IP(num_ranks) == 1)} {
		lappend wr_summary [list "  Memory Calibration" [DE4_SOPC_ddr2_0_p0_format_3dp $mp_setup_slack] [DE4_SOPC_ddr2_0_p0_format_3dp $mp_hold_slack]]
	}		
	...
	if {$IP(write_deskew_mode) == "dynamic"} {
		...
		set extra_shift [expr $board(intra_DQS_group_skew) + [DE4_SOPC_ddr2_0_p0_round_3dp [expr (1.0-$t9_vt_variation_percent)*$t(WL_PSE)]]]
		...
		lappend wr_summary [list "  Deskew Write and/or more clock pessimism removal" [DE4_SOPC_ddr2_0_p0_format_3dp $deskew_setup] [DE4_SOPC_ddr2_0_p0_format_3dp $deskew_hold]]
		...
		lappend wr_summary [list "  Quantization error" [DE4_SOPC_ddr2_0_p0_format_3dp [expr 0-$t9_quantization]] [DE4_SOPC_ddr2_0_p0_format_3dp [expr 0-$t9_quantization]]]
		...
		lappend wr_summary [list "  Calibration uncertainty" [DE4_SOPC_ddr2_0_p0_format_3dp [expr 0-$t9_variation]] [DE4_SOPC_ddr2_0_p0_format_3dp [expr 0-$t9_variation]]] 
		...
		lappend wr_summary [list "  Spatial correlation pessimism removal" [DE4_SOPC_ddr2_0_p0_format_3dp $pessimism_setup] [DE4_SOPC_ddr2_0_p0_format_3dp $pessimism_hold]]
	...
	if {($IP(write_dcc) == "dynamic")} {
		...
		lappend wr_summary [list "  Duty cycle correction quantization error" [DE4_SOPC_ddr2_0_p0_format_3dp [expr 0-$DCC_quantization]] [DE4_SOPC_ddr2_0_p0_format_3dp [expr 0-$DCC_quantization]]]
		...
		lappend wr_summary [list "  Duty cycle correction calibration uncertainity" [DE4_SOPC_ddr2_0_p0_format_3dp [expr 0-$dcc_variation]] [DE4_SOPC_ddr2_0_p0_format_3dp [expr 0-$dcc_variation]]]
	}
	...
	if {($IP(write_deskew_mode) == "dynamic")} {
		set fcolour [DE4_SOPC_ddr2_0_p0_get_colours $setup_slack $hold_slack]
		add_row_to_table -id $panel_id [list "After Calibration Write" [DE4_SOPC_ddr2_0_p0_format_3dp $setup_slack] [DE4_SOPC_ddr2_0_p0_format_3dp $hold_slack]] -fcolor $fcolour
		lappend summary [list $opcname 0 "Write ($opcname)" $setup_slack $hold_slack]
	} else {
		set fcolour [DE4_SOPC_ddr2_0_p0_get_colours $setup_slack $hold_slack] 
		add_row_to_table -id $panel_id [list "Write" [DE4_SOPC_ddr2_0_p0_format_3dp $setup_slack] [DE4_SOPC_ddr2_0_p0_format_3dp $hold_slack]] -fcolor $fcolour
		lappend summary [list $opcname 0 "Write ($opcname)" [DE4_SOPC_ddr2_0_p0_format_3dp $setup_slack] [DE4_SOPC_ddr2_0_p0_format_3dp $hold_slack]]
	}
	...
	if {[string equal -nocase $uncertainty_reporting on]} {
		...
		add_row_to_table -id $panel_id [list "  FPGA uncertainty" [DE4_SOPC_ddr2_0_p0_format_3dp $t(wru_fpga_uncertainty_s)] [DE4_SOPC_ddr2_0_p0_format_3dp $t(wru_fpga_uncertainty_h)]] 
		add_row_to_table -id $panel_id [list "  External uncertainty" [DE4_SOPC_ddr2_0_p0_format_3dp $t(wru_extl_uncertainty_s)] [DE4_SOPC_ddr2_0_p0_format_3dp $t(wru_extl_uncertainty_h)]] 
		add_row_to_table -id $panel_id [list "Deskew" "" ""]
		add_row_to_table -id $panel_id [list "  FPGA deskew" [DE4_SOPC_ddr2_0_p0_format_3dp $t(wru_fpga_deskew_s)] [DE4_SOPC_ddr2_0_p0_format_3dp $t(wru_fpga_deskew_h)]] 
		add_row_to_table -id $panel_id [list "  External deskew" [DE4_SOPC_ddr2_0_p0_format_3dp $t(wru_external_deskew_s)] [DE4_SOPC_ddr2_0_p0_format_3dp $t(wru_external_deskew_h)]] 
		add_row_to_table -id $panel_id [list "  Calibration uncertainty/error" [DE4_SOPC_ddr2_0_p0_format_3dp $t(wru_calibration_uncertaintyerror_s)] [DE4_SOPC_ddr2_0_p0_format_3dp $t(wru_calibration_uncertaintyerror_h)]] 
	}		
}
...
#############################################################
proc DE4_SOPC_ddr2_0_p0_perform_flexible_read_capture_timing_analysis {opcs opcname inst family DQS_min_max io_std interface_type max_package_skew dqs_phase period all_dq_pins pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name fpga_name} {
	...
	set fpga(tDQS_PSERR) [ expr [ get_integer_node_delay -integer $::GLOBAL_DE4_SOPC_ddr2_0_p0_dqs_delay_chain_length -parameters {IO MAX HIGH} -src DQS_PSERR -in_fitter ] / 1000.0 ]
	...
	if {($result == 1)} {
		...
		foreach qpins $pins(q_groups) {
			...
			set DQSperiphery_delay [DE4_SOPC_ddr2_0_p0_max_in_collection $DQSperiphery_min "arrival_time"]
			...
			foreach qpin $qpins {
				...
				# Perform the default timing analysis to get required and arrival times
				set pin_setup_slack [DE4_SOPC_ddr2_0_p0_min_in_collection_from_name $paths_setup "slack" $qpin]
				set pin_hold_slack  [DE4_SOPC_ddr2_0_p0_min_in_collection_from_name $paths_hold "slack" $qpin]
	...
	set fcolour [DE4_SOPC_ddr2_0_p0_get_colours $default_setup_slack $default_hold_slack]
	if {$IP(read_deskew_mode) == "dynamic"} {
		lappend rc_summary [list "  Before Calibration Read Capture" [DE4_SOPC_ddr2_0_p0_format_3dp $default_setup_slack] [DE4_SOPC_ddr2_0_p0_format_3dp $default_hold_slack]]
	} else {
		lappend rc_summary [list "  Standard Read Capture" [DE4_SOPC_ddr2_0_p0_format_3dp $default_setup_slack] [DE4_SOPC_ddr2_0_p0_format_3dp $default_hold_slack]] 
	}
	
	if {($IP(read_deskew_mode) == "dynamic") && ($IP(mp_calibration) == 1) && ($IP(num_ranks) == 1)} {
		lappend rc_summary [list "  Memory Calibration" [DE4_SOPC_ddr2_0_p0_format_3dp $mp_setup_slack] [DE4_SOPC_ddr2_0_p0_format_3dp $mp_hold_slack]] 
	}
	...
	if {$IP(read_deskew_mode) == "dynamic"} {
		...
		set extra_shift [expr $board(intra_DQS_group_skew) + [DE4_SOPC_ddr2_0_p0_round_3dp [expr (1.0-$t1_vt_variation_percent)*$fpga(tDQS_PSERR)]]]
		...
		set deskew_setup [expr $setup_slack - $default_setup_slack - $mp_setup_slack]
		set deskew_hold  [expr $hold_slack - $default_hold_slack - $mp_hold_slack]
		lappend rc_summary [list "  Deskew Read" [DE4_SOPC_ddr2_0_p0_format_3dp $deskew_setup] [DE4_SOPC_ddr2_0_p0_format_3dp $deskew_hold]]
		...
		lappend rc_summary [list "  Quantization error" [DE4_SOPC_ddr2_0_p0_format_3dp [expr 0-$t1_quantization]] [DE4_SOPC_ddr2_0_p0_format_3dp [expr 0-$t1_quantization]]]
		...
		lappend rc_summary [list "  Calibration uncertainty" [DE4_SOPC_ddr2_0_p0_format_3dp [expr 0-$t1_variation]] [DE4_SOPC_ddr2_0_p0_format_3dp [expr 0-$t1_variation]]]
		...
		set pessimism_setup [expr $setup_slack - $default_setup_slack - $mp_setup_slack]
		set pessimism_hold  [expr $hold_slack - $default_hold_slack - $mp_hold_slack]
		lappend rc_summary [list "  Spatial correlation pessimism removal" [DE4_SOPC_ddr2_0_p0_format_3dp $pessimism_setup] [DE4_SOPC_ddr2_0_p0_format_3dp $pessimism_hold]] 
	...
	if {$IP(read_deskew_mode) == "dynamic"} {
		set fcolour [DE4_SOPC_ddr2_0_p0_get_colours $setup_slack $hold_slack] 
		add_row_to_table -id $panel_id [list "After Calibration Read Capture" [DE4_SOPC_ddr2_0_p0_format_3dp $setup_slack] [DE4_SOPC_ddr2_0_p0_format_3dp $hold_slack]] -fcolor $fcolour
		lappend summary [list $opcname 0 "Read Capture ($opcname)" $setup_slack $hold_slack]
	} else {
		set fcolour [DE4_SOPC_ddr2_0_p0_get_colours $setup_slack $hold_slack] 
		add_row_to_table -id $panel_id [list "Read Capture" [DE4_SOPC_ddr2_0_p0_format_3dp $setup_slack] [DE4_SOPC_ddr2_0_p0_format_3dp $hold_slack]] -fcolor $fcolour
		lappend summary [list $opcname 0 "Read Capture ($opcname)" $setup_slack $hold_slack]  
	}	
	...
	if {[string equal -nocase $uncertainty_reporting on]} {
		...
		add_row_to_table -id $panel_id [list "Value" "Setup Side" "Hold Side"]
		add_row_to_table -id $panel_id [list "Uncertainty" "" ""]
		add_row_to_table -id $panel_id [list "  FPGA uncertainty" [DE4_SOPC_ddr2_0_p0_format_3dp $t(rdu_fpga_uncertainty_s)] [DE4_SOPC_ddr2_0_p0_format_3dp $t(rdu_fpga_uncertainty_h)]] 
		add_row_to_table -id $panel_id [list "  External uncertainty" [DE4_SOPC_ddr2_0_p0_format_3dp $t(rdu_extl_uncertainty_s)] [DE4_SOPC_ddr2_0_p0_format_3dp $t(rdu_extl_uncertainty_h)]] 
		add_row_to_table -id $panel_id [list "Deskew" "" ""]
		add_row_to_table -id $panel_id [list "  FPGA deskew" [DE4_SOPC_ddr2_0_p0_format_3dp $t(rdu_fpga_deskew_s)] [DE4_SOPC_ddr2_0_p0_format_3dp $t(rdu_fpga_deskew_h)]] 
		add_row_to_table -id $panel_id [list "  External deskew" [DE4_SOPC_ddr2_0_p0_format_3dp $t(rdu_external_deskew_s)] [DE4_SOPC_ddr2_0_p0_format_3dp $t(rdu_external_deskew_h)]] 
		add_row_to_table -id $panel_id [list "  Calibration uncertainty/error" [DE4_SOPC_ddr2_0_p0_format_3dp $t(rdu_calibration_uncertaintyerror_s)] [DE4_SOPC_ddr2_0_p0_format_3dp $t(rdu_calibration_uncertaintyerror_h)]] 
	}
...
proc DE4_SOPC_ddr2_0_p0_perform_phy_analyses {opcs opcname inst inst_controller pin_array_name timing_parameters_array_name summary_name IP_name} {
...
proc DE4_SOPC_ddr2_0_p0_perform_ac_analyses {opcs opcname inst DQS_min_max pin_array_name timing_parameters_array_name summary_name IP_name} {
...
proc DE4_SOPC_ddr2_0_p0_perform_flexible_write_levelling_timing_analysis {opcs opcname instname family period dll_length interface_type tJITper tJITdty tDCD pll_steps pin_array_name timing_parameters_array_name summary_name  MP_name IP_name SSN_name board_name ISI_parameters_name} {
	...
	set dqs_launch_time [DE4_SOPC_ddr2_0_p0_max_in_collection $data_hold "latch_time"]
	set clk_launch_time [DE4_SOPC_ddr2_0_p0_min_in_collection $ac_setup "latch_time"]
	...
	set clk_min [DE4_SOPC_ddr2_0_p0_min_in_collection [get_path -from $pins(pll_ck_clock) -to $pins(ck_pins) -min_path] "arrival_time"]
	...
	set dqs_max [expr [DE4_SOPC_ddr2_0_p0_max_in_collection $dqs_path_part1 "arrival_time"] + [DE4_SOPC_ddr2_0_p0_max_in_collection $dqs_path_part2 "arrival_time"]]
	...
	# Get the min CLK delay
	set clk_max [DE4_SOPC_ddr2_0_p0_max_in_collection [get_path -from $pins(pll_ck_clock) -to $pins(ck_pins)] "arrival_time"]
	...
	set dqs_min [expr [DE4_SOPC_ddr2_0_p0_min_in_collection $dqs_path_part1 "arrival_time"] + [DE4_SOPC_ddr2_0_p0_min_in_collection $dqs_path_part2 "arrival_time"]]
...
proc DE4_SOPC_ddr2_0_p0_perform_flexible_bus_turnaround_time_analysis {opcs opcname instname family period dll_length interface_type tJITper tJITdty tDCD pll_steps pin_array_name timing_parameters_array_name summary_name  MP_name IP_name SSN_name board_name ISI_parameters_name} {
	...
	set max_dly [expr [DE4_SOPC_ddr2_0_p0_max_in_collection $ac_hold "clock_skew"]]
	...
	set min_dly [expr [DE4_SOPC_ddr2_0_p0_min_in_collection $ac_setup "clock_skew"]]
...
proc DE4_SOPC_ddr2_0_p0_perform_resync_timing_analysis {opcs opcname inst fbasename family DQS_min_max io_std interface_type period pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name fpga_name SSN_name} {
	...
	set max_dqs_common_to_fifo [DE4_SOPC_ddr2_0_p0_max_in_collection [get_path -from $dqs_pins -to $fifo -nworst 1] "arrival_time"]
