...
#      in the DE4_SOPC_ddr2_0_p0_timing.tcl script.
#    * The helper routines are defined in DE4_SOPC_ddr2_0_p0_pin_map.tcl
#
# NOTE
# ----
...
source "$script_dir/DE4_SOPC_ddr2_0_p0_timing.tcl"
...
set entity_names_on [ DE4_SOPC_ddr2_0_p0_are_entity_names_on ]
	...
	set io_standard "$::GLOBAL_DE4_SOPC_ddr2_0_p0_io_standard CLASS I"

	# This is the peak-to-peak jitter on the whole read capture path
	set DQSpathjitter [expr [get_io_standard_node_delay -dst DQDQS_JITTER -io_standard $io_standard -parameters [list IO $::GLOBAL_DE4_SOPC_ddr2_0_p0_io_interface_type] -in_fitter]/1000.0]
	set DQSpathjitter_setup_prop [expr [get_io_standard_node_delay -dst DQDQS_JITTER_DIVISION -io_standard $io_standard -parameters [list IO $::GLOBAL_DE4_SOPC_ddr2_0_p0_io_interface_type] -in_fitter]/100.0]

	# This is the peak-to-peak jitter on the whole write path
	set outputDQSpathjitter [expr [get_io_standard_node_delay -dst OUTPUT_DQDQS_JITTER -io_standard $io_standard -parameters [list IO $::GLOBAL_DE4_SOPC_ddr2_0_p0_io_interface_type] -in_fitter]/1000.0]
	set outputDQSpathjitter_setup_prop [expr [get_io_standard_node_delay -dst OUTPUT_DQDQS_JITTER_DIVISION -io_standard $io_standard -parameters [list IO $::GLOBAL_DE4_SOPC_ddr2_0_p0_io_interface_type] -in_fitter]/100.0]

	set tJITper [expr [get_io_standard_node_delay -dst MEM_CK_PERIOD_JITTER -io_standard $io_standard  -parameters [list IO $::GLOBAL_DE4_SOPC_ddr2_0_p0_io_interface_type] -in_fitter -period $t(CK)]/2000.0]
	...
	set half_period [ DE4_SOPC_ddr2_0_p0_round_3dp [ expr $t(CK) / 2.0 ] ]

	# Half of reference clock
	set ref_half_period [ DE4_SOPC_ddr2_0_p0_round_3dp [ expr $t(refCK) / 2.0 ] ]
	...
	set data_output_min_delay [ DE4_SOPC_ddr2_0_p0_round_3dp [ expr - $t(wru_output_min_delay_external) - $t(wru_output_min_delay_internal)]]
	...
	set data_output_max_delay [ DE4_SOPC_ddr2_0_p0_round_3dp [ expr $t(wru_output_max_delay_external) + $t(wru_output_max_delay_internal)]]
	...
	set data_input_max_delay [ DE4_SOPC_ddr2_0_p0_round_3dp [ expr $t(rdu_input_max_delay_external) + $t(rdu_input_max_delay_internal) ]]
	...
	set data_input_min_delay [ DE4_SOPC_ddr2_0_p0_round_3dp [ expr - $t(rdu_input_min_delay_external) - $t(rdu_input_min_delay_internal) ]]

	# Minimum delay on address and command paths
	set ac_min_delay [ DE4_SOPC_ddr2_0_p0_round_3dp [ expr - $t(IH) -$fpga(tPLL_JITTER) - $fpga(tPLL_PSERR) - $board(intra_addr_ctrl_skew) + $board(addresscmd_CK_skew) - $ISI(addresscmd_hold) ]]

	# Maximum delay on address and command paths
	set ac_max_delay [ DE4_SOPC_ddr2_0_p0_round_3dp [ expr $t(IS) +$fpga(tPLL_JITTER) + $fpga(tPLL_PSERR) + $board(intra_addr_ctrl_skew) + $board(addresscmd_CK_skew) + $ISI(addresscmd_setup) ]]
...
if { ! [ info exists DE4_SOPC_ddr2_0_p0_sdc_cache ] } {
	set DE4_SOPC_ddr2_0_p0_sdc_cache 1
	DE4_SOPC_ddr2_0_p0_initialize_ddr_db DE4_SOPC_ddr2_0_p0_ddr_db
} else {
	if { $debug } {
...
# following loop
set instances [ array names DE4_SOPC_ddr2_0_p0_ddr_db ]
foreach { inst } $instances {
	if { [ info exists pins ] } {
		# Clean-up stale content
		unset pins
	}
	array set pins $DE4_SOPC_ddr2_0_p0_ddr_db($inst)
	...
	set fpga(tDQS_PHASE_JITTER) [ expr [ get_integer_node_delay -integer $::GLOBAL_DE4_SOPC_ddr2_0_p0_dqs_delay_chain_length -parameters {IO MAX HIGH} -src DQS_PHASE_JITTER -in_fitter ] / 1000.0 ]
	...
	set fpga(tDQS_PSERR) [ expr [ get_integer_node_delay -integer $::GLOBAL_DE4_SOPC_ddr2_0_p0_dqs_delay_chain_length -parameters {IO MAX HIGH} -src DQS_PSERR -in_fitter ] / 1000.0 ]
		...
		set final_data_input_max_delay [ DE4_SOPC_ddr2_0_p0_round_3dp [ expr $data_input_max_delay + $fpga(tDQS_PSERR) ]]
		set final_data_input_min_delay [ DE4_SOPC_ddr2_0_p0_round_3dp [ expr $data_input_min_delay - $t(CK) / 2.0 + $t(QH_time) - $fpga(tDQS_PSERR) - $tJITper]]


	if { $debug } {
		post_message -type info "SDC: Jitter Parameters"
		post_message -type info "SDC: -----------------"
		post_message -type info "SDC:    DQS Phase: $::GLOBAL_DE4_SOPC_ddr2_0_p0_dqs_delay_chain_length"
	...
	# PLL Clock Names
	set local_pll_afi_clk [DE4_SOPC_ddr2_0_p0_get_clock_name_from_pin_name_pre_vseries $pll_afi_clock "afi_clk"]
	set local_pll_mem_clk [DE4_SOPC_ddr2_0_p0_get_clock_name_from_pin_name_pre_vseries $pll_ck_clock "mem_clk"]
	set local_pll_addr_cmd_clk [DE4_SOPC_ddr2_0_p0_get_clock_name_from_pin_name_pre_vseries $pll_ac_clock "addr_cmd_clk"]
	set local_pll_write_clk [DE4_SOPC_ddr2_0_p0_get_clock_name_from_pin_name_pre_vseries $pll_write_clock "write_clk"]
	set local_pll_avl_clock [DE4_SOPC_ddr2_0_p0_get_clock_name_from_pin_name_pre_vseries $pll_avl_clock "avl_clk"]
	set local_pll_config_clock [DE4_SOPC_ddr2_0_p0_get_clock_name_from_pin_name_pre_vseries $pll_config_clock "config_clk"]
	...
	# W A R N I N G !
	# The PLL parameters are statically defined in the DE4_SOPC_ddr2_0_p0_parameters.tcl
	...
	# apply those changes to the PLL parameters in the DE4_SOPC_ddr2_0_p0_parameters.tcl

	set pll_i 5
	create_generated_clock -add -name "$local_pll_afi_clk" -source $pll_ref_clock -multiply_by $::GLOBAL_DE4_SOPC_ddr2_0_p0_pll_mult(0) -divide_by $::GLOBAL_DE4_SOPC_ddr2_0_p0_pll_div(0) -phase $::GLOBAL_DE4_SOPC_ddr2_0_p0_pll_phase(0) $pll_afi_clock
	if {[string compare -nocase $pll_afi_clock $pll_ck_clock]==0} {
		set local_pll_mem_clk $local_pll_afi_clk
	} else {
		create_generated_clock -add -name "$local_pll_mem_clk" -source $pll_ref_clock -multiply_by $::GLOBAL_DE4_SOPC_ddr2_0_p0_pll_mult(1) -divide_by $::GLOBAL_DE4_SOPC_ddr2_0_p0_pll_div(1) -phase $::GLOBAL_DE4_SOPC_ddr2_0_p0_pll_phase(1) $pll_ck_clock
	}
	create_generated_clock -add -name "$local_pll_addr_cmd_clk" -source $pll_ref_clock -multiply_by $::GLOBAL_DE4_SOPC_ddr2_0_p0_pll_mult(3) -divide_by $::GLOBAL_DE4_SOPC_ddr2_0_p0_pll_div(3) -phase $::GLOBAL_DE4_SOPC_ddr2_0_p0_pll_phase(3) $pll_ac_clock
	set write_clk_phase $::GLOBAL_DE4_SOPC_ddr2_0_p0_pll_phase(2)
	create_generated_clock -add -name "$local_pll_write_clk" -source $pll_ref_clock -multiply_by $::GLOBAL_DE4_SOPC_ddr2_0_p0_pll_mult(2) -divide_by $::GLOBAL_DE4_SOPC_ddr2_0_p0_pll_div(2) -phase $write_clk_phase $pll_write_clock
	set avl_pll_clk_i $pll_i
	if {[string compare -nocase $pll_afi_clock $pll_avl_clock]==0} {
		set local_pll_avl_clock $local_pll_afi_clk
	} else {
		create_generated_clock -add -name "$local_pll_avl_clock" -source $pll_ref_clock -multiply_by $::GLOBAL_DE4_SOPC_ddr2_0_p0_pll_mult($pll_i) -divide_by $::GLOBAL_DE4_SOPC_ddr2_0_p0_pll_div($pll_i) -phase $::GLOBAL_DE4_SOPC_ddr2_0_p0_pll_phase($pll_i) $pll_avl_clock
	}
	incr pll_i
	create_generated_clock -add -name "$local_pll_config_clock" -source $pll_ref_clock -multiply_by $::GLOBAL_DE4_SOPC_ddr2_0_p0_pll_mult($pll_i) -divide_by $::GLOBAL_DE4_SOPC_ddr2_0_p0_pll_div($pll_i) -phase $::GLOBAL_DE4_SOPC_ddr2_0_p0_pll_phase($pll_i) $pll_config_clock
	incr pll_i
	...
	if {(($::quartus(nameofexecutable) eq "quartus_fit"))} {
		set_max_delay -from $pins(fifo_rdaddress_reg) -to $pins(fifo_rddata_reg) [DE4_SOPC_ddr2_0_p0_round_3dp [expr $t(CK)/2.0]]
	...
	if {(270 - $::GLOBAL_DE4_SOPC_ddr2_0_p0_pll_phase(3)) > 90 || ($::GLOBAL_DE4_SOPC_ddr2_0_p0_pll_phase(3) - 270) > 90} {
		foreach { ck_pin } $ck_pins {
	...
	set_min_delay -from [get_registers $capture_reg] -to $fifo_wrdata_reg [ DE4_SOPC_ddr2_0_p0_round_3dp [expr -$t(CK) + 0.20 ]]

}

	if {(($::quartus(nameofexecutable) ne "quartus_fit") && ($::quartus(nameofexecutable) ne "quartus_map"))} {
		set dqs_clocks [DE4_SOPC_ddr2_0_p0_get_all_instances_dqs_pins DE4_SOPC_ddr2_0_p0_ddr_db]
...
add_ddr_report_command "source [list [file join [file dirname [info script]] ${::GLOBAL_DE4_SOPC_ddr2_0_p0_corename}_report_timing.tcl]]"
