...
lappend arg_list "--component-param=SEQ_ROM=DE4_SOPC_ddr2_0_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=DE4_SOPC_ddr2_0_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=DE4_SOPC_ddr2_0_s0_inst_ROM.hex"
...
lappend arg_list "--output-name=DE4_SOPC_ddr2_0_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=STRATIXIV"
lappend arg_list "--report-file=sopcinfo:DE4_SOPC_ddr2_0_s0.sopcinfo"
lappend arg_list "--report-file=txt:DE4_SOPC_ddr2_0_s0_seq_ipd_report.txt"
lappend arg_list "--file-set=QUARTUS_SYNTH"
catch { eval [concat [list exec "/home/kmurray/altera/12.1/quartus/sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
