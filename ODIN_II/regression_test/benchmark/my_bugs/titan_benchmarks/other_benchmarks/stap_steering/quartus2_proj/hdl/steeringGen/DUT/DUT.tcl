...
} elseif {![file exists "./rtl/steeringGen/DUT/DUT.tcl"]}    {
...
set_global_assignment -name TOP_LEVEL_ENTITY steeringGen_DUT
set_global_assignment -name DEVICE AUTO
set_global_assignment -name DEVICE_FILTER_SPEED_GRADE 2
set_global_assignment -name USE_TIMEQUEST_TIMING_ANALYZER ON
set_global_assignment -name SDC_FILE ./rtl/steeringGen/DUT/DUT.sdc

source ./rtl/steeringGen/DUT/DUT.add.tcl

set_instance_assignment -name VIRTUAL_PIN ON -to azang_s
set_instance_assignment -name VIRTUAL_PIN ON -to chan_s
set_instance_assignment -name VIRTUAL_PIN ON -to dp_s
set_instance_assignment -name VIRTUAL_PIN ON -to elang_s
set_instance_assignment -name VIRTUAL_PIN ON -to en_s
set_instance_assignment -name VIRTUAL_PIN ON -to go_s
set_instance_assignment -name VIRTUAL_PIN ON -to prf_s
set_instance_assignment -name VIRTUAL_PIN ON -to qc_s
set_instance_assignment -name VIRTUAL_PIN ON -to qdone_s
set_instance_assignment -name VIRTUAL_PIN ON -to qm_re
set_instance_assignment -name VIRTUAL_PIN ON -to qm_im
set_instance_assignment -name VIRTUAL_PIN ON -to qv_s

source "./rtl/steeringGen/DUT/steeringGen_DUT_fpc.add.tcl"
